# 258 — Choose or pin a template

**Phase** 12 · Capture  |  **Depends on** [216](216-capture-screen.md), [157](../09-templates/157-template-list.md)
...
- `lib/features/capture/presentation/template_picker_sheet.dart` (new)
