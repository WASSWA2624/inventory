# 250 — Inline template fields on capture

**Phase** 12 · Capture  |  **Depends on** [216](216-capture-screen.md), [154](../09-templates/154-field-type-registry.md)
...
- `lib/features/capture/presentation/inline_fields_section.dart` (new)
