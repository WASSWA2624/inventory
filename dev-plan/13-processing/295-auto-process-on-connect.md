# 295 — Automatic processing when connected

**Phase** 13 · Processing pipeline  |  **Depends on** [260](260-job-queue.md), [035](../02-foundation/035-connectivity-service.md), [136](../07-operator-and-settings/136-settings-store.md)
