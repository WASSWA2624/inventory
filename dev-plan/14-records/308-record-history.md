# 308 — Record history view

**Phase** 14 · Records  |  **Depends on** [090](../04-data-layer/090-audit-table.md), [304](304-record-detail.md)
...
- `lib/features/records/presentation/record_history_screen.dart` (new)
