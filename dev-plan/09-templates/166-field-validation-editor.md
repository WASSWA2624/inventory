# 166 — Field validation rules editor

**Phase** 09 · Templates  |  **Depends on** [163](163-field-advanced-attributes.md)
...
- `lib/features/templates/presentation/field_validation_editor.dart` (new)
