# 155 — Shipped template asset format and atomicity checker

**Phase** 09 · Templates  |  **Depends on** [153](153-template-model.md), [154](154-field-type-registry.md)
...
- Obey `frontend/.rules/`. The ones that bite here: `frontend/.rules/01-structure.md`, `frontend/.rules/03-state-and-data.md`, `frontend/.rules/13-workflow.md`.
...
- [ ] Tests written and passing: `frontend/test/tool/check_templates_test.dart` runs the checker over valid and deliberately broken fixture assets.
