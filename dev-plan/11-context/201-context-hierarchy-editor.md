# 201 — Define the context hierarchy

**Phase** 11 · Context fields  |  **Depends on** [200](200-context-model.md), [161](../09-templates/161-field-list-editor.md)
...
- `lib/features/context/presentation/context_hierarchy_screen.dart` (new)
