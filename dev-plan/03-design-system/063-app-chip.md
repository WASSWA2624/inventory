...
Compact, tappable value display used by context, filters and selections.

## Files

- `lib/core/widgets/app_chip.dart` (new)

## Contract

```dart
class AppChip extends StatelessWidget { final String label; final IconData? icon; final bool selected; final VoidCallback? onTap, onDismiss; }
class AppChipRow extends StatelessWidget { final List<AppChip> chips; final bool scrollable; }
```

## Steps

1. Variants: plain, selectable, dismissible, and a scrollable row with overflow handling.
