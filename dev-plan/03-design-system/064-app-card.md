...
**Phase** 03 · Design system  |  **Depends on** [045](045-elevation-tokens.md)
...
```dart
class AppCard extends StatelessWidget { final Widget child; final EdgeInsets? padding; final VoidCallback? onTap; final int elevationLevel; }
```
