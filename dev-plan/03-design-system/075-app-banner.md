...
The offline and warning banner that sits under the app bar.

## Files

- `lib/core/widgets/feedback/app_banner.dart` (new)

## Contract

```dart
class AppBanner extends StatelessWidget { final String message; final IconData icon; final SnackTone tone; final VoidCallback? onDismiss; }
```
