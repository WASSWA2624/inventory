# 488 — Authentication middleware

**Phase** 25 · Optional team backend  |  **Depends on** [487](487-be-auth-tokens.md)
...
Verify the access token, load the principal and attach it to the request context.
...
- [ ] An expired or malformed token returns 401 with the standard envelope.
- [ ] Tests written and passing: Tests for valid, expired, malformed and missing tokens.
