# 403 — Conflict resolution screen

**Phase** 19 · Bundles and merge  |  **Depends on** [397](397-merge-auto-rules.md), [336](../16-review/336-evidence-viewer.md)
...
- `lib/features/merge/presentation/conflict_screen.dart` (new)
