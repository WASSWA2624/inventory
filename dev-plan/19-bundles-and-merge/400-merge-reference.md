# 400 — Merge reference datasets

**Phase** 19 · Bundles and merge  |  **Depends on** [395](395-merge-entity-level.md), [102](../04-data-layer/102-reference-tables.md)
...
- `lib/features/merge/domain/merge_reference.dart` (new)
