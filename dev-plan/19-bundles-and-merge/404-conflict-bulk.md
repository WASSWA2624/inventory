# 404 — Bulk conflict resolution

**Phase** 19 · Bundles and merge  |  **Depends on** [403](403-conflict-screen.md)
...
- `lib/features/merge/presentation/conflict_bulk_actions.dart` (new)
