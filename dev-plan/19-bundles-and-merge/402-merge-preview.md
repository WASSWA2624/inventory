# 402 — Merge preview screen

**Phase** 19 · Bundles and merge  |  **Depends on** [395](395-merge-entity-level.md), [065](../03-design-system/065-app-list-tile.md)
...
- `lib/features/merge/presentation/merge_preview_screen.dart` (new)
